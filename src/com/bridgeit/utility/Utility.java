...
public class Utility {
	...
	public static LinkedList1 addRemove1(boolean status, String searchNUmber, LinkedList1 ll) {
	...
	public static void readFile1(LinkedList1 l3, String searchWord,boolean status,String line)
	{
		...
		try {
			FileWriter writer = new FileWriter("abcd.text",false);
			BufferedWriter write = new BufferedWriter(writer);
			if(status==true)
			{
				String replace = line.replace(searchWord,"");
  ...
  public static JSONArray jsonFileReader(String filePath) throws FileNotFoundException
  {
    ...
    public JSONArray jsonFileWriter(String filePath,JSONArray jsonArray)
    {
